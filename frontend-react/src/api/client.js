...
export const explainRiskProfile = (data, lang = 'en') =>
  request('/risk-profile/explain', { method: 'POST', body: JSON.stringify({ ...data, lang }), headers: { 'Content-Type': 'application/json' } })
